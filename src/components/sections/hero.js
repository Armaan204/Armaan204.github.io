...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Armaan Rehman Shah.</h2>;
  const three = <h3 className="big-heading">I decode the language of data.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a className="email-link" href="www.linkedin.com/in/armaanrs" target="_blank" rel="noreferrer">
